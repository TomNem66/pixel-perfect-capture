...
Edge function analyze-vop uses Google Gemini 2.0 Flash API with GEMINI_API_KEY.
...
- [Edge function](mem://features/edge-function) — analyze-vop with crawler, legal-fetcher, Gemini Flash API
